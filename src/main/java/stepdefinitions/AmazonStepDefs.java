...
//        // Assert.assertTrue(resultText.getText().contains("30,000") );
        ...
        String [] name = resultText.getText().trim().split(" ");
        System.out.println(Arrays.toString(name));
        int result2 = Integer.parseInt(name[3].replace(",",""));


            Assert.assertEquals(result2,30000);
